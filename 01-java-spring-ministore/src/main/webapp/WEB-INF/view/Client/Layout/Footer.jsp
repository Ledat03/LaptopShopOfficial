            ...
            <div class="col-md-4 col-sm-6">
                <div class="Shipping d-flex">
                    ...
                    <div class="card-wrap ps-2">
                        <img src="${pageContext.request.contextPath}/images/HomePage/dhl.png" alt="visa">
                        <img src="${pageContext.request.contextPath}/images/HomePage/shippingcard.png" alt="mastercard">
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="payment-method d-flex">
                    <p>Payment options:</p>
                    <div class="card-wrap ps-2">
                        <img src="${pageContext.request.contextPath}/images/HomePage/visa.jpg" alt="visa">
